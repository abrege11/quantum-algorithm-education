...
const buttonObjList = [modTwoDiv, classicalAlgorithmDiv, quantumAlgorithmDiv, jozsaQuantumCircuitDiv, jozsaSymbolsDiv, jozsaHadamardDiv, jozsaSuperpositionDiv, jozsaQuantumOracleDiv, quantumSupremacyDiv];
